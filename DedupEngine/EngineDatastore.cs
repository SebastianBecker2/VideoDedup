namespace DedupEngine
{
    ...
    using System.IO;
    using VideoDedupShared.DateTimeExtension;
    using VideoDedupShared.SqlDataReaderExtension;
    using System;
    ...
    internal class EngineDatastore : Datastore
    {
        ...
        public IEnumerable<ImageSet> GetImages(
            ...
            using (var command = new SQLiteCommand(connection))
            {
                ...
                using (var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        yield return new ImageSet { Index = index, Bytes = bytes };
                    }
                }
            }
        }
